  ...
  return (
    <section className="about wrapper">
      ...
      <p>
        ...
        favourite cartoons, TV shows, music albums, & more with easy filtering
        functionlity. With Immemorial, stay up-ti-date with all your 90s
        favourites while turning back time.
      </p>
      <p>
        {" "}
